...
int main(int argc, char const *argv[]) {
  ...
  struct piece *computer_pieces =
      create_computer_pieces(); // Create enemy piece
  char **chessboard =
      create_chessboard(user_pieces, computer_pieces); // Create chessboard
  ...
  while (cota < 100) {
    ...
    hilos_Jugador = create_routine_pieces(
        user_pieces, chessboard); // Create the threads of the player pieces
    printf(
        "//////////////////////////////////////////////////////////////////\n");
    ...
    if (chessPlayer != 0) {
      ...
      if (chessEnemy != 0) {
        ...
        chessboard =
            rewrite_chessboard(chessboard, user_pieces, computer_pieces);
        print_chessboard(chessboard);
